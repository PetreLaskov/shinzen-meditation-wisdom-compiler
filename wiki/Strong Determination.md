---
type: concept
thesis: "Strong Determination is Shinzen's voluntary-immobility practice route in which intense touch and Feel/Image/Talk eruptions can become learning material, but only when sensory retraining, optionality, bodily safety, and practice capacity outrank endurance."
status: working
...
## Key Points
- **Core claim**: Strong Determination can expose local touch, global body spread, fear, rage, sadness, agitation, mental protest, and imagery as practice objects, but the value lies in CCE-based learning rather than endurance, harm, or collapse.
- **Why this matters**: The route is vivid and easy to misuse; future agents need a page that routes intensity through learning, sensory decomposition, and safety boundaries.
- **Key tensions**: Shinzen's four-hour autobiographical example is practice-significant, and the later general talk adds no-harm and limping warnings, but neither provides full readiness, medical, trauma, coercion, teacher, or stop criteria.
- **Source posture**: Strong as evidence for Shinzen's oral framing; only probable as a general practice model and speculative on safety until later Gate 3 sources fill criteria.

## Model
The second Zero and One talk defines the basic form. A Strong Determination Sit is a chosen period of no voluntary movement, often at least an hour and theoretically longer. Shinzen introduces it as optional and interesting, then parses the resulting eruption as physical touch plus Feel/Image/Talk, including pain, shaking, fear, confusion, distorted thinking, and loss-of-control impressions ([[Zero and One - Part 2 of 4 Complete Experiences Cont'd, Strong Determination Sits]] S5-S6).

The third Zero and One talk gives the route its governing criterion. The point is not how much the practitioner can endure. It is how much the practitioner can learn from what happens, and learning primarily means that touch, Feel, Image, and Talk circuits stop fighting themselves ([[Zero and One - Part 3 Strong Determination Challenges, Benefits, and Tasting Purification]] S3-S4).

[[Strong Determination Meditation Sits]] gives the compact general
instruction. Shinzen defines the practice as a chosen period without
voluntary movement, encourages occasional long or immobile sits as one way to
push the envelope, and immediately adds two guardrails: do not damage the
body, and do not turn the practice into "how much can I take for how long."
If a sitting choice leaves the practitioner limping for half an hour
...
The later general talk preserves the same divide-and-conquer structure with a
simple arithmetic handle. If ten units each of touch, Feel, Image, and Talk
stay separate, Shinzen says the challenge is additive and workable; if they
tangle, it can feel multiplicative and unbearable. The value of Strong
...
The route is not endurance training in a macho vein. A mild experience with clear learning is better than a severe experience that is merely endured. Duration, intensity, shaking, imagery, and dramatic emotion are therefore not evidence of completion by themselves ([[Zero and One - Part 3 Strong Determination Challenges, Benefits, and Tasting Purification]] S3).

The Equanimity and Purification sequence adds a bounded-austerity criterion.
Shinzen describes dhutanga-style uncomfortable practices as allowed rather
than required, and says the Buddha did not allow practices that harm the body
or wipe the person out so badly that they are not really practicing anymore
([[Equanimity and the Taste of Purification - Part 2 of 2]] S4-S5). This is
not a full stop protocol, but it means harm and practice-destroying wipeout
are disqualifiers inside the source's own frame.

The general Strong Determination talk makes the body-harm boundary more
practical. Shinzen says practitioners should experiment carefully and treat
lingering impairment, such as limping for half an hour after a sit, as a sign
that the chosen sitting mode is not appropriate. This does not become a
...
Its future value in the wiki is mostly diagnostic. It tests whether [[Complete Experience]] is being confused with endurance, whether purification taste is being confused with intensity-seeking, and whether austerity stories are being transmitted with enough caution.
