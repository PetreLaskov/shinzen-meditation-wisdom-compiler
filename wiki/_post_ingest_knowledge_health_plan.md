...
2026-05-31 automation handoff: the active bounded multi-session work is now
specified in `wiki/_compiler_health_multisession_plan.md`. Use this file as
the broader health/refactor reference, but use the multi-session plan for the
current automation's workstream order and stop condition.
